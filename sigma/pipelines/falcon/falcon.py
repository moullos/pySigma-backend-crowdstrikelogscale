from sigma.pipelines.common import logsource_windows_ps_script,logsource_windows,logsource_windows_ps_classic_start,logsource_windows_driver_load, logsource_windows_dns_query,logsource_windows_image_load, logsource_windows_process_creation, logsource_linux_process_creation,logsource_windows_network_connection, logsource_windows_network_connection_initiated,logsource_linux_network_connection
from sigma.pipelines.base import Pipeline
from sigma.processing.transformations import ReplaceStringTransformation,AddConditionTransformation,ChangeLogsourceTransformation, DropDetectionItemTransformation, FieldMappingTransformation, DetectionItemFailureTransformation, MapStringTransformation
from sigma.processing.conditions import RuleContainsDetectionItemCondition, IncludeFieldCondition, MatchStringCondition
...
def generate_unsupported_process_field_processing_item(field):
    return  ProcessingItem(
                ...
                transformation=DetectionItemFailureTransformation(f"Crowdstrike Query Language does not support the {field} field"),
                rule_conditions=[
...
def falcon_pipeline() -> ProcessingPipeline:    
    return ProcessingPipeline(
        name="CrowdStrike Agent Pipeline",
        ...
        items=[
            ...
            ProcessingItem(
                identifier="cql_process_creation_win",
                transformation =AddConditionTransformation({
                    "event_platform": "Win"
                }),
                rule_conditions=[
            ...
            ProcessingItem(
                ...
                transformation=DetectionItemFailureTransformation("Only file name of parent image is available in CrowdStrike Query Language events."),
                field_name_conditions=[
            ...
            ProcessingItem(
                ...
                transformation=DetectionItemFailureTransformation('Integrity Level needs to be one of Protected,System,High,Medium_Plus,Medium,Low,Untrusted'),
                field_name_conditions=[
                    IncludeFieldCondition(fields=["IntegrityLevel"])
                ],
                rule_conditions = [
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="Protected"),
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="System"),
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="High"),
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="Medium_Plus"),
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="Medium"),
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="Low"),
                    RuleContainsDetectionItemCondition(field="IntegrityLevel",value="Untrusted"),
                ],
                rule_condition_linking=any,
            ...
            ProcessingItem(
                ...
                transformation=DetectionItemFailureTransformation('Integrity Level needs to be one of A,NS,CNAME,PTR,MX,TXT,AAAA,ANY'),
                field_name_conditions=[
                    IncludeFieldCondition(fields=["RequestType"])
                ],
                rule_conditions = [
                    ...
                    RuleContainsDetectionItemCondition(field="RequestType",value="CNAME"),
                    RuleContainsDetectionItemCondition(field="RequestType",value="PTR"),
                    RuleContainsDetectionItemCondition(field="RequestType",value="MX"),
                    RuleContainsDetectionItemCondition(field="RequestType",value="TXT"),
                    RuleContainsDetectionItemCondition(field="RequestType",value="AAAA"),
                    RuleContainsDetectionItemCondition(field="RequestType",value="ANY"),
                ],
                rule_condition_linking=any,
                rule_condition_negation=True
            ),
            ...
            generate_unsupported_image_load_field_processing_item("Signed"), # partially supported but not consistently
            ...
            ProcessingItem(
             ...
             # ContextBaseFileName handling
                ...
                transformation=DetectionItemFailureTransformation("Only file name of image is available in CrowdStrike Query Language events."),
                field_name_conditions=[
